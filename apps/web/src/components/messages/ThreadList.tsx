...
const selectedFilterClasses: Record<MessageFilters["tab"], string> = {
  all: "border-primary/20 bg-primary/10 text-primary",
  unread: "border-primary/20 bg-primary/10 text-primary",
  mine: "border-secondary/20 bg-secondary/10 text-secondary",
  org: "border-muted bg-muted text-muted-foreground",
};
              ...
              <button
                ...
                className={cn(
                  ...
                  activeFilter === filter.value
                    ? selectedFilterClasses[filter.value]
